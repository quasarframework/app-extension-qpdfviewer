<template>
  <q-layout view="HHh LpR fFf" @scroll="onScroll">
    ...
    <q-footer elevated class="glass">
      <q-toolbar>
        <div class="full-width text-center">This documentation site for QPdfviewer is a work in progress. If you see something missing or inaccurate, please create a PR on the <markdown-link to="https://github.com/quasarframework/app-extension-qpdfviewer/tree/next" style="color: white;">GitHub repo</markdown-link>.</div>
      </q-toolbar>
    </q-footer>
...
export default defineComponent({
  ...
  setup () {
    const path = ref(null),
      basePath = 'https://github.com/quasarframework/app-extension-qpdfviewer/tree/next/docs/src/examples/',
      name = ref(null),
