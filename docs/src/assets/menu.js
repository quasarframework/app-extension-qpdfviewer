...
const menu = [
  {
    name: 'All about QPdfviewer',
    path: 'all-about-qpdfviewer',
    expanded: false,
    children: [
      {
        name: 'What is QPdfviewer',
        path: 'what-is-qpdfviewer'
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        name: 'Using QPdfviewer',
        path: 'using-qpdfviewer'
      }
    ]
  },
  {
    ...
    children: [
      {
        name: 'GitHub',
        external: true,
        path: 'https://github.com/quasarframework/app-extension-qpdfviewer',
        rightIcon: biGithub
      },
      {
        name: 'Twitter',
